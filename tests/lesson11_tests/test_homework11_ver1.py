...
def user_login_events_handler(file_path,name,user_status):
    with open(log_file) as log:
        ...
        # checking log info correspondence with the last line only
...
class TestUserLogin:
    ...
    def test_successful_login(self):
        # clear_logfile_input(log_file)  # not necessary, because I check the correspondence with the last line only
        status = "success"
